...
const navItems: Record<UserRole, NavItem[]> = {
  ...
  [UserRole.PARENT]: [
    ...
    { href: appRoutes.parent.family, label: 'Family', icon: Users },
  ...
  [UserRole.ADMIN]: [
    { href: appRoutes.admin.dashboard, label: 'Dashboard', icon: LayoutDashboard },
    { href: appRoutes.admin.students, label: 'Students', icon: Users },
    { href: appRoutes.admin.leads, label: 'Leads', icon: Target },
    { href: appRoutes.admin.bookings, label: 'Bookings', icon: CalendarClock },
    { href: appRoutes.admin.enrolments, label: 'Enrolments', icon: BookOpen },
    { href: appRoutes.admin.schedule, label: 'Schedule', icon: Calendar },
    { href: appRoutes.admin.workflow, label: 'Enrol. Workflow', icon: GitBranch },
    { href: appRoutes.admin['enrolment-reports'], label: 'Enrol. Reports', icon: FileBarChart },
    { href: appRoutes.admin.attendance, label: 'Attendance', icon: ClipboardCheck },
    { href: appRoutes.admin.homework, label: 'Homework', icon: Award },
    { href: appRoutes.admin.notifications, label: 'Notifications', icon: MessageSquare },
    { href: appRoutes.admin['class-workflow'], label: 'Class Workflow', icon: Repeat },
    { href: appRoutes.admin.makeup, label: 'Make-up Sessions', icon: Calendar },
    { href: appRoutes.admin['academic-reports'], label: 'Academic Reports', icon: BarChart3 },
    { href: appRoutes.admin['fee-rules'], label: 'Fee Rules', icon: DollarSign },
    { href: appRoutes.admin.invoices, label: 'Invoices', icon: FileText },
    { href: appRoutes.admin.payments, label: 'Payments', icon: CreditCard },
    { href: appRoutes.admin.overdue, label: 'Overdue', icon: ShieldAlert },
    { href: appRoutes.admin.analytics, label: 'Analytics', icon: LineChart },
    { href: appRoutes.admin.users, label: 'Users', icon: Users },
    { href: appRoutes.admin.classes, label: 'Classes', icon: BookOpen },
    { href: appRoutes.admin.content, label: 'Content', icon: FileText },
    { href: appRoutes.admin.reports, label: 'System Reports', icon: BarChart3 },
    { href: appRoutes.admin.emails, label: 'Emails', icon: Mail },
    { href: appRoutes.admin.system, label: 'System', icon: Server },
